vim.pack.add({
    { src = 'https://github.com/ThePrimeagen/99.git', version = 'master' },
}, { confirm = false })
...
alias.set("v", "<leader>9v", function() _99.visual() end)

--- if you have a request you dont want to make any changes, just cancel it
alias.set("n", "<leader>9x", function() _99.stop_all_requests() end)

alias.set("n", "<leader>9s", function() _99.search() end)
